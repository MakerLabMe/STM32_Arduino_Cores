...
typedef struct _DeviceVectors
{
  ...
  void* pfnTAMPER_IRQHandler;                   /*  2 */
  void* pfnRTC_IRQHandler;                   /*  3 */
  ...
  void* pfnDMA1_Channel1_IRQHandler;           /* 11  */
  void* pfnDMA1_Channel2_IRQHandler;           /* 12 */
  void* pfnDMA1_Channel3_IRQHandler;           /* 13 */
  void* pfnDMA1_Channel4_IRQHandler;           /* 14 */
  void* pfnDMA1_Channel5_IRQHandler;           /* 15 */
  void* pfnDMA1_Channel6_IRQHandler;           /* 16 */
  void* pfnDMA1_Channel7_IRQHandler;         /* 17  */
  void* pfnADC1_2_IRQHandler;                       /* 18  */
  void* pfnUSB_HP_CAN1_TX_IRQHandler;        /* 19  */
  void* pfnUSB_LP_CAN1_RX0_IRQHandler;        /* 20  */
  void* pfnCAN1_RX1_IRQHandler;            /* 21 */
  void* pfnCAN1_SCE_IRQHandler;             /* 22*/
  void* pfnEXTI9_5_IRQHandler;             /* 23*/
  void* pfnTIM1_BRK_TIM15_IRQHandler;       /* 24*/
  void* pfnTIM1_UP_TIM16_IRQHandler;         /* 25*/
  void* pfnTIM1_TRG_COM_TIM17_IRQHandler;    /* 26 */
  ...
  void* pfnTIM6_IRQHandler;               /* 54  */
  void* pfnTIM7_IRQHandler;               /* 55  */
  void* pfnDMA2_Channel1_IRQHandler;   /* 56  */
